# ========================= MODEL ARCHITECTURE =========================
# Exact copy from v1_4class_model/train.py (post-synchronization)
# DO NOT modify any layer, dimension, or dropout value —
# the best_model.pth state_dict keys must match exactly.
...
class DroneFullModel(nn.Module):
    def __init__(self, num_classes=4, c=64):
        super().__init__()
